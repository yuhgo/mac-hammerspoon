...
-- カーソル移動
remapKey({'right_ctrl'}, 'j', keyCode('left'))
remapKey({'right_ctrl'}, 'k', keyCode('down'))
remapKey({'right_ctrl'}, 'i', keyCode('up'))
remapKey({'right_ctrl'}, 'l', keyCode('right'))
remapKey({'right_ctrl', 'shift'}, 'j', keyCode('left', {'shift'}))
remapKey({'right_ctrl', 'shift'}, 'k', keyCode('down', {'shift'}))
remapKey({'right_ctrl', 'shift'}, 'i', keyCode('up', {'shift'}))
remapKey({'right_ctrl', 'shift'}, 'l', keyCode('right', {'shift'}))
remapKey({'right_ctrl', 'cmd'}, 'j', keyCode('left', {'cmd'}))
remapKey({'right_ctrl', 'cmd'}, 'k', keyCode('down', {'cmd'}))
remapKey({'right_ctrl', 'cmd'}, 'i', keyCode('up', {'cmd'}))
remapKey({'right_ctrl', 'cmd'}, 'l', keyCode('right', {'cmd'}))
remapKey({'right_ctrl', 'shift', 'cmd'}, 'j', keyCode('left', {'shift', 'cmd'}))
remapKey({'right_ctrl', 'shift', 'cmd'}, 'k', keyCode('down', {'shift', 'cmd'}))
remapKey({'right_ctrl', 'shift', 'cmd'}, 'i', keyCode('up', {'shift', 'cmd'}))
...
remapKey({'right_ctrl'}, 'h', keyCode('delete'))
